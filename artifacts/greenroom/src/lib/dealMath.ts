import type { Deal, Expense, TicketSale, Bonus } from "./types";
...
export function calculateSettlement(input: CalcInput): SettlementCalculation {
  ...
  if (deal.dealType === "flat") {
    ...
    return {
      supported: true,
      grossBoxOffice, netBoxOffice, totalExpenses,
      ...
      steps: [
        ...
        ...bonusResult.applied.map((b) => ({
          label: b.label, value: b.amount, note: b.reason,
        })),
      ],
