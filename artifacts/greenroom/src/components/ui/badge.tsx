...
> = {
  booked: { bg: "bg-ink-100", fg: "text-ink-700", ring: "ring-ink-200/80", dot: "bg-ink-400" },
  advanced: { bg: "bg-sky-50", fg: "text-sky-800", ring: "ring-sky-200/80", dot: "bg-sky-700" },
  day_of: { bg: "bg-amber-50", fg: "text-amber-800", ring: "ring-amber-200/80", dot: "bg-amber-700" },
  settled: { bg: "bg-brand-50", fg: "text-brand-800", ring: "ring-brand-200/80", dot: "bg-brand-700" },
  closed: { bg: "bg-ink-50", fg: "text-ink-500", ring: "ring-ink-200/80", dot: "bg-ink-400" },
};

const statusLabels: Record<Status, string> = {
  booked: "Booked", advanced: "Advanced", day_of: "Day of",
...
export function StatusBadge({
  ...
  status: Status; className?: string; showDot?: boolean;
}) {
...
const dealStyles: Record<string, { bg: string; fg: string; ring: string }> = {
  flat: { bg: "bg-ink-50", fg: "text-ink-700", ring: "ring-ink-200/80" },
  percentage_of_gross: { bg: "bg-ink-50", fg: "text-ink-700", ring: "ring-ink-200/80" },
  percentage_of_net: { bg: "bg-amber-50", fg: "text-amber-800", ring: "ring-amber-200/80" },
  vs: { bg: "bg-amber-50", fg: "text-amber-800", ring: "ring-amber-200/80" },
  door: { bg: "bg-rose-50", fg: "text-rose-800", ring: "ring-rose-200/80" },
};
